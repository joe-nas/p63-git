...
parallel -j20 --gnu --eta 'bedtools shuffle -chrom -seed {1} -i ../data/hg19/p63all_sort_merge_hg.19.bed -g ../data/hg19/hg19.genome | bedtools intersect -a stdin -b ../data/hg19/encode/peaks/{2} | wc -l >> ../results/tables/p63_exp_vs_ovs_overlap/hg19_p63_obs_vs_exp_{2}' ::: $(seq 1 1000) ::: $(ls ../data/hg19/encode/peaks/);
